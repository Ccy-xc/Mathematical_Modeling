...
\baominghao{24106180103} %参赛队号
\schoolname{重庆交通大学}%学校名称
\membera{汪云飞} %队员A
\memberb{程春雨} %队员B
\memberc{杨棋} %队员C
\begin{document}
 ...
 %填写摘要
\begin{abstract}
本模板是在全国研究生数学建模竞赛 \LaTeX{} 模板的基础上修订了一点内容的新模板, 旨在让大家专注于
...
% \textbf{LaTeX交流群：【721519365】，B站搜索关注：【数模加油站】获取更多数模相关教程资料。}


% \uwave{欢迎关注微信公众号}：

% \centerline{\includegraphics[width=6cm]{gongzhonghao}}

% PS：本人只是改了一个标识页，其他的均为\LaTeX 工作室制作。
